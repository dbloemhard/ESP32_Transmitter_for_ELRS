...
const uint8_t analogInPinAileron =  0;
const uint8_t analogInPinElevator = 1;
const uint8_t analogInPinThrottle = 3;
const uint8_t analogInPinRudder =   4;
const uint8_t VOLTAGE_READ_PIN =    2;
